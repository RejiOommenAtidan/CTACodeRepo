...
export const EditDialog = (props) => {
  ...
  const [receivedDate, setReceivedDate] = React.useState((props.bookFullObj.dtReceived) ? props.bookFullObj.dtReceived.split('T')[0] : null);
  ...
  const [issueActionDate, setIssueActionDate] = React.useState(props.bookFullObj.dtIssueAction ? (props.bookFullObj.dtIssueAction).split('T')[0] : null);
...
placeholder="DD-MM-YYYY"
                        ...
                        onChange={(date) => {
                          if (date) {
                            ...
                            setValue('dtDate', date, { shouldValidate: true });
...
placeholder="DD-MM-YYYY"
                        ...
                        onChange={(date) => {
                          if (date) {
                            setRejectDate(date);
                            setValue('dtRejectDate', date, { shouldValidate: true });
                          }
                        }}
                        KeyboardButtonProps={{
                          "aria-label": "change date",
...
placeholder="DD-MM-YYYY"
                        ...
                        onChange={(date) => {
                          if (date) {
                            setReturnDate(date);
                            setValue('dtReturnDate', date, { shouldValidate: true });
                          }
                        }}
                        KeyboardButtonProps={{
                          "aria-label": "change date",
