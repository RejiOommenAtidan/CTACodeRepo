  ...
  const snackbarClose = () => {
    ...
    <>
      <Paper style={{padding:'30px',textAlign:'center'}} >
        <h1>Abroad Report</h1>
        <form onSubmit={()=>{handleSubmit(abroad())}}>
                                  ...
                                  <FormControl className={classes.formControl}>
                                   ...
                                   <FormControl className={classes.formControl}>
                                        <Button type="button" variant='outlined' value="Report" onClick={()=>{abroad();}} >Show</Button>
                                        </FormControl>
                                   <FormControl className={classes.formControl}>
                                        { abroadData &&
                                        <Button type="button" variant='outlined' onClick={()=>{SetAbroadData();}} >Clear</Button>
                                        }
                                    </FormControl>
                                    </form>
