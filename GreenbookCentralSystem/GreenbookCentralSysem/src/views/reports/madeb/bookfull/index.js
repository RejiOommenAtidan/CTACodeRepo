  ...
  const snackbarClose = () => {
    ...
    <>
      <Paper style={{padding:'30px',textAlign:'center'}} >
        <h1>Bookfull Report</h1>
        <form onSubmit={()=>{handleSubmit(bookfull())}}>
                                  ...
                                  <FormControl className={classes.formControl}>
                                   ...
                                   <FormControl className={classes.formControl}>
                                        <Button type="button" variant='outlined' value="Report" onClick={()=>{bookfull();}} >Show</Button>
                                        </FormControl>
                                   <FormControl className={classes.formControl}>
                                        { bookfullData &&
