      ...
      <DialogContent>
        <DialogContentText>
          <Grid container>
            ...
            <Grid item xs={12}>
              <FormControl className={props.classes.formControl}>
                <InputLabel id="id_sMarried">Married</InputLabel>
                <Select
                  id="id_sMarried"
                  label="Married"
                  type="text"
            ...
            <Grid item xs={12}>
              <FormControl className={props.classes.formControl}>
                <TextField
                  ...
                  type="number"
                  onChange={(e) => { setnChildrenM(e.target.value); }}
                  fullWidth
                  margin="normal"
                  required
                  className={props.classes.textField}
            ...
            <Grid item xs={12}>
              <FormControl className={props.classes.formControl}>
                <TextField
                  ...
                  type="number"
                  onChange={(e) => { setnChildrenF(e.target.value); }}
                  fullWidth
                  margin="normal"
                  required
                  className={props.classes.textField}
            ...
            <Grid item xs={12}>
              <FormControl className={props.classes.formControl}>
                <TextField
                  ...
                  label="Book Issued"
                  type="text"
                  onChange={(e) => { setsBookIssued(e.target.value); }}
                  fullWidth
                  margin="normal"
                  required
                  className={props.classes.textField}
