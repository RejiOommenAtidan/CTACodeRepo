...
namespace ChatrelPaymentWebAPI.Masters
{
    [Authorize]
        ...
        public IActionResult GetAuthRegions()
        {
            ...
            try
            {
                ...
                if (authRegions.Count() > 0)
                {
                    ...
                    ChatrelLogger logger = new ChatrelLogger(_info);
            ...
            try
            {
                ...
                if (region != null && regionToUpdate != null && RegionID == regionToUpdate.ID.ToString())
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        {
                            #region Audit Log
                            ChatrelLogger.LogAuditRecord(region, regionToUpdate, null, null, 27, region.ID, regionToUpdate.nUpdatedBy);
                            #endregion
