...
import { Switch, Text, View, ScrollView, StyleSheet } from 'react-native';
    ...
    <ScrollView>
      <View style={styles.main}>
        <View style={styles.container}>
          ...
          <Text>Please Provide the following Information for verification</Text>
          <Input
            label="Friend's GBID"
...
FriendChatrelIntermediateScreen.navigationOptions = navData => {
  return {
