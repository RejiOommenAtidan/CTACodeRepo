...
const GoogleLoginPage = (props) => (
    <GoogleLogin
        ...
        onSuccess={(response) => { console.log("Login Successful: ",response); localStorage.setItem("currentUser", JSON.stringify(response.profileObj));window.location='/selfpayment'; }}
