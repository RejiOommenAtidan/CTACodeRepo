        ...
        <Grid container spacing={6}>
          <Grid item xl={4}>
            <Card className="p-4 text-center">
              ...
              <div className="text-black-50 pt-2">
                This server has a <b className="text-success">regular</b> load
                at the moment.
              </div>
              ...
              <div className="d-flex align-items-center justify-content-center">
                <Button
                  size="small"
                  variant="text"
                  className="btn-outline-second btn-pill">
                  Server Dashboard
                </Button>
              </div>
            </Card>
          ...
          <Grid item xl={4}>
            <Card className="p-4 text-center">
              ...
              <div className="text-black-50 pt-2">
                This server has a <b className="text-danger">high</b> load at
                the moment.
              </div>
              <div className="py-4 my-2">
                <GaugeChart
